...
/* 3. find point of user whose email is 'Tristian7@yahoo.com' 
and display the point and list of user containing that point and display their email adresses
*/

const findUser = data.find((item) => item.email === "Tristian7@yahoo.com");
