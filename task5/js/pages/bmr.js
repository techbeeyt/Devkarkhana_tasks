    ...
    <div class="calc_body">
        <div class="values">
            ...
            <div class="result_text">
                <p class="bmi_result" id="bmr_result_val">BMR : 1700.00 calories/day</p>
            </div>
            <div>
                <p class="more_info">Daily calorie needs based on activity level</p>
                <table cellpadding="2px" border="1px" cellspacing="0" class="margin_2">
                <thead>
                    <tr class="tr_head">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Exercise 4-5 times/weeke</td>
                        <td>2515</td>
                    </tr>
                    <tr class="tr_1">
...
export const bmrDOM = () => {
    ...
    calcBtn.addEventListener("click", () => {
        ...
        if (BMI) {
            $("#bmr_result_val").innerHTML = `BMR: ${BMI.toFixed(2)} calories/day`;
        }
    });
    const clrBtn = $("#clear");
